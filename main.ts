...
namespace mbit_小车类 {
    ...
    export function Music_Car(index: enMusic): void {
        switch (index) {
            ...
            case enMusic.funereal: music.beginMelody(music.builtInMelody(Melodies.Funereal), MelodyOptions.Once); break;
